...
class AuthController extends Controller
{
    ...
    public function login()
    {
        ...
        return $this->_render($this->config->views['login'], ['config' => $this->config,'judulHalaman' => 'Login - Temu Ruang']);
    }
    ...
    public function register()
    {
        ...
        return $this->_render($this->config->views['register'], ['config' => $this->config, 'judulHalaman' => 'Register - Temu Ruang']);
    }
